...
Based on previous transaction & performance data from the last 18 campaigns,the task was t0 predict the probability for the next 10 campaigns in the test set for each coupon and customer combination, whether the customer will redeem the coupon or not?

Dataset Description
Here is the schema for the different data tables available. The detailed data dictionary is provided next.
![image](https://user-images.githubusercontent.com/83906275/185683287-440a70aa-31d8-43ae-b323-c2c6507618b8.png)
